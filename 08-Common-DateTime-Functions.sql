...
SELECT DATEDIFF(day, '2004-08-06', GETDATE()) AS DaysBetween
GO
...
-- Getting the name of the current week day
...
-- Converting a datetime to a different format in VARCHAR, 
--The third argument, 103, specifies the style code for the conversion. 
...
-- Getting the last day of the current month
SELECT EOMONTH('2025-02-06') AS LastDayOfCurrentMonth
GO
